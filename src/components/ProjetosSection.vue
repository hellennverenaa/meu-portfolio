    ...
    <div class="max-w-7xl mx-auto">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 md:gap-6">
        ...
        >
          ...
          <div class="absolute top-0 left-0 right-0 h-px bg-linear-to-r from-transparent via-ultraviolet/30 to-transparent rounded-t-2xl"></div>

          <!-- Glow hover -->
          <div class="absolute inset-0 rounded-2xl bg-linear-to-b from-ultraviolet/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"></div>
